...
# Import Quick Prompt Builder nodes
from .quick_prompt_nodes import NODE_CLASS_MAPPINGS as QUICK_PROMPT_MAPPINGS
from .quick_prompt_nodes import NODE_DISPLAY_NAME_MAPPINGS as QUICK_PROMPT_DISPLAY_MAPPINGS
NODE_CLASS_MAPPINGS.update(QUICK_PROMPT_MAPPINGS)
NODE_DISPLAY_NAME_MAPPINGS.update(QUICK_PROMPT_DISPLAY_MAPPINGS)

# Import Creative Helper nodes
from .creative_helper_nodes import NODE_CLASS_MAPPINGS as CREATIVE_HELPER_MAPPINGS
from .creative_helper_nodes import NODE_DISPLAY_NAME_MAPPINGS as CREATIVE_HELPER_DISPLAY_MAPPINGS
NODE_CLASS_MAPPINGS.update(CREATIVE_HELPER_MAPPINGS)
NODE_DISPLAY_NAME_MAPPINGS.update(CREATIVE_HELPER_DISPLAY_MAPPINGS)

# Import Animation Frame nodes
from .animation_frame_nodes import NODE_CLASS_MAPPINGS as ANIM_FRAME_MAPPINGS
from .animation_frame_nodes import NODE_DISPLAY_NAME_MAPPINGS as ANIM_FRAME_DISPLAY_MAPPINGS
NODE_CLASS_MAPPINGS.update(ANIM_FRAME_MAPPINGS)
NODE_DISPLAY_NAME_MAPPINGS.update(ANIM_FRAME_DISPLAY_MAPPINGS)



# Import Intelligent Offload (New Phase)
from .intelligent_offload_nodes import NODE_CLASS_MAPPINGS as OFFLOAD_MAPPINGS
from .intelligent_offload_nodes import NODE_DISPLAY_NAME_MAPPINGS as OFFLOAD_DISPLAY_MAPPINGS
NODE_CLASS_MAPPINGS.update(OFFLOAD_MAPPINGS)
NODE_DISPLAY_NAME_MAPPINGS.update(OFFLOAD_DISPLAY_MAPPINGS)

# Import Aesthetic Master V2 (New Phase)
from .aesthetic_master_v2 import NODE_CLASS_MAPPINGS as AESTHETIC_V2_MAPPINGS
from .aesthetic_master_v2 import NODE_DISPLAY_NAME_MAPPINGS as AESTHETIC_V2_DISPLAY_MAPPINGS
NODE_CLASS_MAPPINGS.update(AESTHETIC_V2_MAPPINGS)
NODE_DISPLAY_NAME_MAPPINGS.update(AESTHETIC_V2_DISPLAY_MAPPINGS)

# Import Act Perfection (New Phase)
from .act_perfection_nodes import NODE_CLASS_MAPPINGS as ACT_PERFECTION_NEW_MAPPINGS
from .act_perfection_nodes import NODE_DISPLAY_NAME_MAPPINGS as ACT_PERFECTION_NEW_DISPLAY_MAPPINGS
NODE_CLASS_MAPPINGS.update(ACT_PERFECTION_NEW_MAPPINGS)
NODE_DISPLAY_NAME_MAPPINGS.update(ACT_PERFECTION_NEW_DISPLAY_MAPPINGS)

# Import Anime Character Selector nodes
from .anime_character_nodes import NODE_CLASS_MAPPINGS as ANIME_CHAR_MAPPINGS
from .anime_character_nodes import NODE_DISPLAY_NAME_MAPPINGS as ANIME_CHAR_DISPLAY_MAPPINGS
NODE_CLASS_MAPPINGS.update(ANIME_CHAR_MAPPINGS)
NODE_DISPLAY_NAME_MAPPINGS.update(ANIME_CHAR_DISPLAY_MAPPINGS)

# Import Celebrity Character Selector nodes
from .celebrity_character_nodes import NODE_CLASS_MAPPINGS as CELEB_CHAR_MAPPINGS
...
# Import Anime/Cartoon Character Selector V2 (300+ characters)
from .anime_character_v2_nodes import NODE_CLASS_MAPPINGS as ANIME_V2_MAPPINGS
from .anime_character_v2_nodes import NODE_DISPLAY_NAME_MAPPINGS as ANIME_V2_DISPLAY_MAPPINGS
NODE_CLASS_MAPPINGS.update(ANIME_V2_MAPPINGS)
NODE_DISPLAY_NAME_MAPPINGS.update(ANIME_V2_DISPLAY_MAPPINGS)

# Import Celebrity Selector V2 (200+ people)
from .celebrity_v2_nodes import NODE_CLASS_MAPPINGS as CELEB_V2_MAPPINGS
from .celebrity_v2_nodes import NODE_DISPLAY_NAME_MAPPINGS as CELEB_V2_DISPLAY_MAPPINGS
NODE_CLASS_MAPPINGS.update(CELEB_V2_MAPPINGS)
NODE_DISPLAY_NAME_MAPPINGS.update(CELEB_V2_DISPLAY_MAPPINGS)

# Import Utility Nodes (TextCombine, PromptBuilder, etc.)
from .utility_nodes import NODE_CLASS_MAPPINGS as UTILITY_MAPPINGS
from .utility_nodes import NODE_DISPLAY_NAME_MAPPINGS as UTILITY_DISPLAY_MAPPINGS
NODE_CLASS_MAPPINGS.update(UTILITY_MAPPINGS)
NODE_DISPLAY_NAME_MAPPINGS.update(UTILITY_DISPLAY_MAPPINGS)
